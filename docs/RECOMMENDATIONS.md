...
| 🟡 7     | **A2** — Rate limiting                         | ✅ Fait            | —             | Moyen                |
| 🟡 8     | **B8** — ADR-SEC-005 limitation de débit       | ✅ Créé (Accepted) | —             | Moyen                |
...
| RGPD                   | FR31 (droit à l'oubli) | FR32–FR34         |
| Observabilité          | FR35–FR39              | —                 |

> L'admin panel complet (FR23–FR26) et la conformité RGPD exhaustive (FR32–FR34) sont les candidats les plus naturels au report V2. FR40 relève du consentement versionné à l'inscription et reste couvert par l'epic 2.
...
4.  ✅ A2  — Rate limiting implémenté pendant Epic 2
5.  ✅ B8  — ADR-SEC-005 créée après A2
