        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              ...
              message:
                'Domain and application layers must stay provider-agnostic. Declare a semantic local application port instead of importing provider SDKs.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                'Cross-slice imports from domain/application are forbidden. Declare a semantic local port or use a proven shared contract.',
            },
          ],
        },
      ],
